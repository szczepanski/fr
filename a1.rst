...
passé composé 
   to express completed actions at any time in the past

   *syntax*
   
   **avoir** or **être** in present tense + **main verb in past participle** 


.. list-table:: **past participle - regular verbs** verb_en (present, regular 1st)
   :widths: auto
   :header-rows: 0
   :align: right

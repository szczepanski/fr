...
passé composé 
   ...
   **examples**
   ...
   ``Je n'ai pas choisi ce restaurant``
   ...
   **examples**
   ...
   ``As-tu mangé avec ton frère pendant le week-end?``
   
   ``Avez-vous visité Lyon pendant votre voyage ?``
   
   ``A-t-elle joué au tennis pendant le week-end ?``

...
passé composé - avoir and être
   ...
   **examples**
   ...
   ``j'ai mangé`` ``tu as fini`` ``il / elle / on a répondu`` ``nous avons visité`` ``vous avez choisi`` ``ils / elles ont vendu``
   ...
   **examples**
   ...
   ``As-tu mangé avec ton frère pendant le week-end?`` ``Avez-vous visité Lyon pendant votre voyage ?`` ``A-t-elle joué au tennis pendant le week-end ?`` ``A-t-il regardé un film hier soir ?``   
...
passé composé - être
   **use**
   ...
   no single principal reason, generally used with verbs of movement, motion, change of place or condition
